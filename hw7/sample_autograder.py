...
if __name__ == '__main__':
    ...
    total_score = 0
    for relu_3 in range(1, ntests + 1):
        if args.single and relu_3 != int(args.test):
            continue
        out = ''
        score = 0
        message = ''
        if True:
            ...
            except Exception as relu_2:
                message = "Exception: " + str(relu_2)
            mess = "{}. {} {}\n".format(relu_3, fnames_description[relu_3 - 1], message)
            print(mess)
